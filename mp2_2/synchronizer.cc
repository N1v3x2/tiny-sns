...
std::vector<std::string> get_all_users(int);
...
public:
    ...
    {
        std::vector<std::string> users = get_all_users(synchID);
    ...
    {
        std::vector<std::string> allUsers = get_all_users(synchID);
...
std::vector<std::string> get_all_users(int synchID)
{
...
std::vector<std::string> getFollowersOfUser(int ID)
{
    ...
    std::vector<std::string> usersInCluster = get_all_users(synchID);
